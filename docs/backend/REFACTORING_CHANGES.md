...
> **Note**: This document covers backend-specific refactoring details. For comprehensive refactoring documentation (backend + frontend), see [../REFACTORING_2025.md](../REFACTORING_2025.md).
