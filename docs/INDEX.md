...
- **[frontend/features/HOME.md](./frontend/features/HOME.md)** - Home screen (sender/outbox)
...
- **[frontend/features/UNFOLDING_HIERARCHY.md](./frontend/features/UNFOLDING_HIERARCHY.md)** - Unfolding hierarchy system (visual prioritization) ⭐ NEW
...
2. **[supabase/DATABASE_SCHEMA.md](./supabase/DATABASE_SCHEMA.md)** - Complete schema
3. **[supabase/LOCAL_SETUP.md](./supabase/LOCAL_SETUP.md)** - Local development
...
**Theming**
- Frontend: [frontend/THEME_SYSTEM.md](./frontend/THEME_SYSTEM.md)
