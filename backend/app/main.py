...
from app.api import auth, capsules, recipients, connections, self_letters, letter_replies, letter_invites
...
app.include_router(letter_invites.router)  # Letter invites endpoints
