...
-- ============================================================================
-- NOTE: User data should be created through Supabase Auth
-- The following is example data structure for reference
-- ============================================================================

/*
Example User Profile (created after auth signup):
INSERT INTO public.user_profiles (user_id, full_name, premium_status, country)
VALUES (
  'user-uuid-from-auth',
  'John Doe',
  false,
...
Example Recipient:
INSERT INTO public.recipients (owner_id, name, email)
VALUES (
  'user-uuid-from-auth',
  'Jane Smith',
  'jane@example.com'
...
INSERT INTO public.capsules (
  ...
  is_anonymous,
  is_disappearing,
  disappearing_after_open_seconds,
  unlocks_at,
  title,
  body_text,
  theme_id,
...
VALUES (
  ...
  NOW() + INTERVAL '7 days',
  'A Letter for You',
  'This is a time-locked letter that will unlock in 7 days.',
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000101'
);
*/
